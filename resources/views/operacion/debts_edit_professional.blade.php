...
<div class="container">
	<form method="POST" action="/deudas_profesional/{{ $debt->id }}" onsubmit="return validar(this);">
	    {{csrf_field()}}
	    {{method_field('PUT')}}
        ...
        <br>
		<h3 class="title">Pago de deuda socio: <span class="normal">{{ $professional->first_name }} {{ $professional->last_name }} {{ $professional->mother_last_name }}</span></h3>
        <br>
