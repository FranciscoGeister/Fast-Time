...
<form method="POST" action="/campañas" enctype="multipart/form-data">
  ...
  <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a>Crear Campaña</a></li>
      </ol>
  </nav>
  <br>
  <h3 class="title">Nombre</h3>
  <input type="text" name="nombre" class="col-sm-4">
  <br>
  <br>
  ...
  Buscar <input id="searchTerm" type="text" onchange="doSearch(this)" onkeyup="doSearch(this)" />
  <br>
...
<script language="javascript">
  function doSearch(obj)
  {
    ...
    var searchText = obj.value.toLowerCase();
    var cellsOfRow="";
    var found=false;
    var compareWith="";
